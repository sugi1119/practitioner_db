class AppointmentsController < ApplicationController
  ...
  def create
    ...
    @check_taken = Appointment.where(taken: true, practitioner_id: @appointment.practitioner_id)
  ...
  def update
    ...
    @check_taken = Appointment.where(taken: true, practitioner_id: @appointment.practitioner_id).where.not(id: @appointment.id)
  ...
  private
    ...
    def check_valid
        ...
        #original booking time within +-1 hour if its available, should be changed.
